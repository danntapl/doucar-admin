...
# Note that you can pass multiple names the `alias` method:
drivers_array \
...
# (1) Create an array called `home_array` that includes driver's home latitude
# and longitude.

# (2) Create a map called `name_map` that includes the driver's first and last
# name.

# (3) Create a struct called `name_struct` that includes the driver's first and
# last name.
